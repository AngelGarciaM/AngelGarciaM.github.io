...
def abrir_correcion():
   ...
   # Crear una lista de diccionarios de EvPDF
    ...
    temp_file_path = f'app\\tmp\\temp_data_{current_user.usuario}.json'
    # Guardar estos datos en un archivo temporal
    with open(temp_file_path, 'w', encoding='utf-8') as f:
        json.dump(evpdf_data, f)
    
    
    resutados_path=f'app\\tmp\\resultados_{current_user.usuario}.json'
...
def abrir_cuestionario():
    ...
    temp_file_path = f'app\\tmp\\temp_data_cuestionario_{current_user.usuario}.json'
    # Guardar estos datos en un archivo temporal
    with open(temp_file_path, 'w', encoding='utf-8') as f:
    ...
    resultados_path = f'app\\tmp\\resultados_cuestionario_{current_user.usuario}.json'
